...
@app.route('/kycface/anadircarasin')
def anadircarasin():
    return render_template('anadircarasin.html')

@app.route('/kycface/detectarrostro')
def detectarrostro():
    return render_template('detectarrostro.html')

@app.route('/kycface/detectarrostrosin')
def detectarrostrosin():
    return render_template('detectarrostrosin.html')
